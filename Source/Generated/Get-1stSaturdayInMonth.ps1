...
.DESCRIPTION
The Get-1stSaturdayInMonth function calculates the date of the 1st Saturday in the specified month and year. It simplifies the process of identifying the date for scheduling events or meetings that recur on the 1st Saturday of a month.
...
.EXAMPLE
Get-1stSaturdayInMonth -Month 9 -Year 2024

This command returns the date of the 1st Saturday of September 2024.

.EXAMPLE
$day = Get-1stSaturdayInMonth -Month 12 -Year 2023
...
.INPUTS
None. You cannot pipe input to Get-1stSaturdayInMonth.
...
.NOTES
This function is a wrapper around Get-NthDayOfWeekInMonth, specifically configured to find the 1st Saturday of the month. Ensure the 'Month' and 'Year' parameters are within their valid ranges to avoid exceptions.
...
function Get-1stSaturdayInMonth {
    ...
    Get-NthDayOfWeekInMonth -Year $Year -Month $Month -DayOfWeek Saturday -Nth 1
}
