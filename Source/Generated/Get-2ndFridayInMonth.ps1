...
.DESCRIPTION
The Get-2ndFridayInMonth function calculates the date of the 2nd Friday in the specified month and year. It simplifies the process of identifying the date for scheduling events or meetings that recur on the 2nd Friday of a month.
...
.EXAMPLE
Get-2ndFridayInMonth -Month 9 -Year 2024

This command returns the date of the 2nd Friday of September 2024.

.EXAMPLE
$day = Get-2ndFridayInMonth -Month 12 -Year 2023
...
.INPUTS
None. You cannot pipe input to Get-2ndFridayInMonth.
