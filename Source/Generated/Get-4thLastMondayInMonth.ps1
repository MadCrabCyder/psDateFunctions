...
.DESCRIPTION
The Get-4thLastMondayInMonth function calculates the date of the 4th Last Monday in the specified month and year. It simplifies the process of identifying the date for scheduling events or meetings that recur on the 4th Last Monday of a month.
...
.EXAMPLE
Get-4thLastMondayInMonth -Month 9 -Year 2024

This command returns the date of the 4th Last Monday of September 2024.

.EXAMPLE
$day = Get-4thLastMondayInMonth -Month 12 -Year 2023
...
.INPUTS
None. You cannot pipe input to Get-4thLastMondayInMonth.
...
#>
function Get-4thLastMondayInMonth {
