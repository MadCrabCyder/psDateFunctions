...
.DESCRIPTION
The Get-4thLastWednesdayInMonth function calculates the date of the 4th Last Wednesday in the specified month and year. It simplifies the process of identifying the date for scheduling events or meetings that recur on the 4th Last Wednesday of a month.
...
.EXAMPLE
Get-4thLastWednesdayInMonth -Month 9 -Year 2024

This command returns the date of the 4th Last Wednesday of September 2024.

.EXAMPLE
$day = Get-4thLastWednesdayInMonth -Month 12 -Year 2023
...
.INPUTS
None. You cannot pipe input to Get-4thLastWednesdayInMonth.
...
#>
function Get-4thLastWednesdayInMonth {
    [Alias('')]
