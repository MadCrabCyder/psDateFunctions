...
.DESCRIPTION
The Get-1stDayInMonth function calculates and returns the first day of a given month and year as a System.DateTime object. It also supports filtering out specific days of the week (such as weekends) to return the first valid "Weekday"
...
.EXAMPLE
Get-1stDayInMonth -Month 7 -Year 2024

Returns the first day of July 2024 as a System.DateTime object.

.EXAMPLE
$firstDay = Get-1stDayInMonth -Month 12 -Year 2023
