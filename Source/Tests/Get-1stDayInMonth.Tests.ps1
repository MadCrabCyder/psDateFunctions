...
Describe 'Get-1stDayInMonth - Happy Path' {
    $testCases=@(
    ...
    it 'Given Year=<Year>, Month=<Month>, should return the correct date' -ForEach $testCases {
        ...
        Get-1stDayInMonth -Year $Year -Month $Month |
            Should -BeExactly (Get-Date -year $Year -Month $Month -Day $ExpectedDay).Date
    }
}

Describe 'Get-1stDayInMonth - Weekday' {
    $testCases=@(
    ...
    it 'Given Year=<Year>, Month=<Month>, should return the correct date' -ForEach $testCases {
        ...
        Get-1stDayInMonth -Year $Year -Month $Month -Weekday|
            Should -BeExactly (Get-Date -year $Year -Month $Month -Day $ExpectedDay).Date
    }
}

Describe 'Get-1stDayInMonth - Exclude Days' {
    $testCases=@(
    ...
    it 'Given Year=<Year>, Month=<Month>, should return the correct date' -ForEach $testCases {
        ...
        Get-1stDayInMonth -Year $Year -Month $Month -ExcludeDays Saturday, Sunday, Monday |
            Should -BeExactly (Get-Date -year $Year -Month $Month -Day $ExpectedDay).Date
    }
}

Describe 'Get-1stDayInMonth Exceptions' {
    Context 'Invalid Month' {
        ...
        it 'Given an invalid month <Month>, should throw an exception' -ForEach $testCases {
            ...
            { Get-1stDayInMonth -Month $Month -Year $Year } |
